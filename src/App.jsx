...
import { getConversations, createConversation, updateConversation, deleteConversation } from './utils/storage'
import { 
...
const models = [
  ...
  { id: "ark-code-latest", name: "Ark Code", desc: "火山·编程", api: "volcengine", vision: false, thinking: false },
  { id: "deepseek-v4-pro", name: "DeepSeek V4 Pro", desc: "火山·DeepSeek", api: "volcengine", vision: false, thinking: false },
  { id: "glm-5-1", name: "GLM 5.1", desc: "火山·智谱", api: "volcengine", vision: false, thinking: false },
  { id: "deepseek-v4-flash", name: "DeepSeek V4 Flash", desc: "火山·轻量", api: "volcengine", vision: false, thinking: false },
      ...
      <div className="main-container">
        ...
        {showModels && (
          <div className="model-dropdown">
            ...
            <div className="model-group-label">火山引擎</div>
            {models.filter(m => m.api === 'volcengine').map(m => (
              <button
                key={m.id}
                className={"model-option " + (m.id === model ? "active" : "")}
                onClick={() => { setModel(m.id); setShowModels(false) }}
