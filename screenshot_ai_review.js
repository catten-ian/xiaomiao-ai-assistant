...
(async () => {
  ...
  await page.screenshot({ path: '/workspace/screenshots/ai-review-fixed.png' });
  console.log('Saved:', fs.statSync('/workspace/screenshots/ai-review-fixed.png').size, 'bytes');
